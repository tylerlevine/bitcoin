...
bool CheckInputs(const CTransaction& tx, CValidationState &state, const CCoinsViewCache &view, bool fScriptChecks,
                 unsigned int flags, bool cacheStore, PrecomputedTransactionData& txdata, std::function<void (const CCoins&, const CTransaction&, unsigned int, unsigned int, bool, PrecomputedTransactionData*)> emplacer = nullptr);
