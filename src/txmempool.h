...
public:
    ...
    mutable uint64_t epoch; //!< epoch when last touched, useful for graph algorithms
};
...
public:
    std::unordered_map<uint256, std::unordered_map<uint32_t, txiter>, SaltedTxidHasher> mapNextTx GUARDED_BY(cs);
