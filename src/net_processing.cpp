...
const static uint32_t allNetMessageTypesEnum[] = {
    ...
    NetMsgTypeEnum::ADDR,
    NetMsgTypeEnum::INV,
    NetMsgTypeEnum::GETDATA,
    NetMsgTypeEnum::MERKLEBLOCK,
    NetMsgTypeEnum::GETBLOCKS,
    NetMsgTypeEnum::GETHEADERS,
    NetMsgTypeEnum::TX,
    NetMsgTypeEnum::HEADERS,
    NetMsgTypeEnum::BLOCK,
    NetMsgTypeEnum::GETADDR,
    NetMsgTypeEnum::MEMPOOL,
    NetMsgTypeEnum::PING,
    NetMsgTypeEnum::PONG,
    NetMsgTypeEnum::NOTFOUND,
    NetMsgTypeEnum::FILTERLOAD,
    NetMsgTypeEnum::FILTERADD,
    NetMsgTypeEnum::FILTERCLEAR,
    NetMsgTypeEnum::REJECT,
    NetMsgTypeEnum::SENDHEADERS,
    NetMsgTypeEnum::FEEFILTER,
    NetMsgTypeEnum::SENDCMPCT,
    NetMsgTypeEnum::CMPCTBLOCK,
